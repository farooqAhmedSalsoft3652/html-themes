                        ...
                        <div class="therapy-card pt-4">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-link active" id="pending" data-toggle="tab" href="#nav-pending" role="tab" aria-controls="nav-pending" aria-selected="true">Pending</a>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active group-therapy" id="nav-pending" role="tabpanel" aria-labelledby="pending">
                                ...
                                <div class="tab-pane fade group-therapy" id="nav-inprocess" role="tabpanel" aria-labelledby="in-process">
                                    <table class="table shopping-cart-wrap m-0">
                                        <tbody>
                                            <tr>
                                                <td class="v-align-middle">
