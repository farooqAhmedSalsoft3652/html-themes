                    ...
                    <nav class="mb-4">
                        <div class="profile_link">
                            ...
                            <div class="profile_addfriend">
                                <a href="#" class="btn-purple"><i class="far fa-comment-alt"></i> Message</a>
                                <!-- <a href="#" class="btn-purple-border"><i class="fas fa-user-check"></i></a> -->
                                <div class="btn-group custom-dropdown">
                                    <a href="javascript:;" class="btn-purple-border" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-check"></i></a>
