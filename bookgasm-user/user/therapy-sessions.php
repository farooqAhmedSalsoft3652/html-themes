        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active group-therapy" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <a href="therapy-logs.php" class="pur">view logs</a>
                        <ul>
                            <li>
                                <div class="therapy-card">
                                    <div class="d-flex justify-content-between top-content">
                                        <div class="">
                                            <h5>ABC Session - mm/dd/yy <span class="yel">$ 000</span></h5>
                                        </div>
                                        <div class="btn-group custom-dropdown ml-2 mb-1">
                                            <button type="button" class="btn btn-drop-table btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-ellipsis-v"></i></button>
                                            <div class="dropdown-menu custom-dropdown">
                                                <a class="dropdown-item" href="join-therapy-session.php">join session</a>
                                            </div>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                                    <div class="d-sm-flex justify-content-between bottom-content">
                                        <div class="">
                                            <h5>Starting Time: <span>00:00 PM</span></h5>
                                            <h6>Ending Time: <span>00:00 PM</span></h6>
                                        </div>
                                        <div class="">
                                            <h5>Seats Left: <span>000</span></h5>
                                        </div>
                                    </div> 
                                </div>
                            </li>
                    ...
                    <div class="tab-pane fade therapy-with-admin" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
