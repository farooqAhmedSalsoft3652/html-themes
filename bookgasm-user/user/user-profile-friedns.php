                    ...
                    <nav class="mb-4">
                        <div class="profile_link">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link" id="timeline" data-toggle="tab" href="#nav-timeline" role="tab" aria-controls="nav-timeline" aria-selected="true">Timeline</a>
                                <a class="nav-link" id="about" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">about</a>
                                <a class="nav-link active" id="friends" data-toggle="tab" href="#nav-friends" role="tab" aria-controls="nav-friends" aria-selected="false">friends</a>
                            </div>
                            <div class="profile_addfriend">
                                <a href="#" class="btn-purple"><i class="fas fa-user-times"></i> Cancel Request</a>
                                <a href="#" class="btn-purple-border"><i class="far fa-comment-alt"></i></a>
                            </div>
                        </div>
                    </nav>    
                    
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade group-therapy" id="nav-timeline" role="tabpanel" aria-labelledby="timeline">
                                    ...
                                    <div class="profile_aboxm d-flex justify-content-center" >
                                        <div class="col-md-5">
                                            ...
                                            <div class="profile_abox mt-5">
                                                ...
                                                <a href="javascript:;" class="btn-purple-border change-password">Change Password</a>
                                            </div>                                        
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade show active group-therapy" id="nav-friends" role="tabpanel" aria-labelledby="friends">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="profile_fboxbott d-flex mt-3 align-items-center">
                                                <div class="user-comment  w-100">
                                                    <img src="images/fprofile_img.png" alt="" class="img-fluid profile-pic mr-2 d-inline-block">
                                                    <p class="p-md mb-0 d-inline-block">Daniel Jacob</p>
                                                </div>
                                                <div class="btn-group custom-dropdown ml-2 mb-1">
                                                    <button type="button" class="btn btn-drop-table btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-ellipsis-v"></i></button>
                                                    <div class="dropdown-menu custom-dropdown"> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="profile_fboxbott d-flex mt-3 align-items-center">
                                                ...
                                                <div class="btn-group custom-dropdown ml-2 mb-1">
                                                    <a class="btn-purple" href="#_">Add Friend</a>
                                                </div>  
                                            </div>                                            
                                        </div>
                                        <div class="col-md-6">
