        ...
        <div class="row">
            <div class="col-lg-3 px-lg-0">
                <div class="social-left-card">
                    <div class="text-center"><img src="images/social-profile.png" alt="" class="img-fluid"></div>
                    <h6 class="mt-3 mb-0">Sammy Aiden</h6>
                    <p class="grey-text mb-0">@Sammy96</p>
                    <div class="social-left-inner mt-3">
                        <p class="my-0 d-grey-text">Posts</p>
                        <p class="my-0 p-lg">700</p>
                    </div>
                    <div class="social-left-inner">
                        <p class="my-0 d-grey-text">Friends</p>
                        <p class="my-0 p-lg">100k</p>
                    </div>
                    <div class="social-left-inner">
                        <p class="my-0 d-grey-text">Requests Sent</p>
                        <p class="my-0 p-lg">05</p>
                    </div>
                </div>
                <div class="social-left-card mt-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <p class="p-md bold mb-0">Your Groups</p>
                        <a href="#_" class="p-xs bold yellow-text mb-0">See All</a>
                    </div>
                    <hr class="my-2">
                    <h6 class="mt-3 mb-0">Sammy Aiden</h6>
                    <p class="grey-text mb-0">@Sammy96</p>
                    ...
                    <div class="social-left-inner border-0 mt-1">
                        <div class="media align-items-center">
                            <img src="images/sm-profile.png" alt="" class="img-fluid mr-2">
                            <div class="media-body">
                                <p class="mb-0 lh-1">Group ABC</p>
